...
- (UIImageView *)posterImageView {
    if (_arrowImageView == nil) {
        CGFloat imageWH = 55;
        UIImageView *posterImageView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 8, imageWH, imageWH)];
//        posterImageView.contentMode = UIViewContentModeScaleAspectFill;
//        posterImageView.clipsToBounds = YES;
//        posterImageView.frame = CGRectMake(0, 0, 70, 70);
        posterImageView.layer.cornerRadius = imageWH / 2;
        posterImageView.clipsToBounds = YES;
...
- (UILabel *)titleLable {
    if (_titleLable == nil) {
        ...
        CGFloat lableH = 20;
        CGFloat lableY = 25;
        titleLable.frame = CGRectMake(90, lableY, self.tz_width - 90 - 50, lableH);
